...
import com.microsoft.android.screenshot.R;


public class NotificationUtils {

    public static final int NOTIFICATION_ID = 1337;
    private static final String NOTIFICATION_CHANNEL_ID = "com.microsoft.android.screenshot.mediaprojectiondemo.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.microsoft.android.screenshot.mediaprojectiondemo.app";
